...
%     - mass exchange between pathways;
    ...
    start_date.month = 1;
    start_date.day = 1;
    max_days = 4; % 365;                                         % number of simulation days
...
%%% TODO: try different variants (floor, ceil, round)
    ...
    residual_time_array = residual_time_array ./ time_discretization;	% Discretized residual time in number of time intervals
    % Array of numbers of cells passed in one time interval
    num_cells_passed = velocity_array .* time_discretization ./ spatial.dz;
